...
This Python module wraps the ...

> [!NOTE]
> This module requires `ffeditc_unicode.exe` from Microsoft Train Simulator.
> It is **not included**. You must provide the executable from your own MSTS installation.
